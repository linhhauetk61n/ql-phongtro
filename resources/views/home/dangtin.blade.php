		...
		<div class="col-md-8">
          ...
          @if(Auth::user()->tinhtrang != 0)
            ...
            <div class="row">
              <div class="col-md-4">
                <div class="form-group">
                  <label for="usr">Giá phòng( vnđ/phòng ):</label>
                  <input type="number" name="txtprice" class="form-control" placeholder="750000" >
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
                  <label for="usr">Điện( vnđ/số điện ):</label>
                  <input type="number" name="txtdien" class="form-control" placeholder="3.5" >
                </div>
              </div>
              <div class="col-md-4">
                <div class="form-group">
                  <label for="usr">Nước( vnđ/người ):</label>
                  <input type="number" name="txtnuoc" class="form-control" placeholder="100000" >
                </div>
              </div>
                ...
                <div class="form-group">
                  <label for="usr">SĐT Liên hệ:</label>
                   @foreach($owners as $owner)
                    @if($owner->id_users ==  Auth::user()->id)
                      <input type="text" name="txtphone" class="form-control" placeholder="{{$owner->phone_number}}" value="{{$owner->phone_number}}">
                    @endif
                  @endforeach
                </div>
              </div>
