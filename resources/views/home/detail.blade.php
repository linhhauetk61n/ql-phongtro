...
<div class="container">
	<div class="row">
		...
		<div class="col-md-4">
			<div class="contactpanel">
				<div class="row">
					...
					<div class="col-md-8">
						...
						<i class="far fa-clock"></i> Ngày tham gia: {{ $motelroom->user->created_at->format('d')}}/{{ $motelroom->user->created_at->format('m')}}/{{ $motelroom->user->created_at->format('Y')}}
			...
			@if(session('thongbaoreview'))
			<div class="alert bg-success">
				<button type="button" class="close" data-dismiss="alert"><span>×</span><span class="sr-only">Close</span></button>
				<span class="text-semibold">Well done!</span>  {{session('thongbaoreview')}}
			</div>
			@endif	
			<a href="user/yeuthich/{{$motelroom->id }}"><button type="button" class="btn btn-danger col-md-12" style="margin-top: 20px; font-size: 16px;">Thêm vào yêu thích</button></a>
				...
				<div class="row" style="margin-top:20px;">
					<div class="col-md-12">
						<div class="well well-sm">
							...
							<div class="row" id="post-review-box" style="display:none;">
								<div class="col-md-12">
									<form accept-charset="UTF-8" action="{{ route('user.review',['id'=> $motelroom->id]) }}" >
										<input id="ratings-hidden" name="rating" type="hidden" value="5"> 
					...
					<div class="col-md-12" style="padding: 0px; margin-top: 15px;">
						...
						<div class="row" style="margin:10px 0px;">
							@if($usercmt[$i]->avatar == 'no-avatar.jpg')
							<img class="img-circle" src="images/no-avatar.jpg" style="height: 50px; width: 50px; margin-right: 15px; float: left;" />
							@else
							<img class="img-circle" src="uploads/avatars/<?php echo $usercmt->avatar; ?>" style="height: 50px; width: 50px; margin-right: 15px; float: left;" />
							@endif
							
							<div style="padding-top: 8px; margin-left: 65px;">
								<strong>{{$usercmt[$i]->name}}</strong>
								<div class="stars starrr" data-rating="{{$review[$i]->star}}" style="margin: 0px; font-size: 18px;"></div>
								<strong>{{$review[$i]->review}}</strong>
							</div>
