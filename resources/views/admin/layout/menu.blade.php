					...
					<div class="sidebar-category sidebar-category-visible">
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li><a href="admin/owners/list"><i class="icon-user-check"></i> <span>Danh sách Người cho thuê</span></a></li>
								...
								<li><a href="admin/reviews/list"><i class="icon-home4"></i><span> Danh sách review</span></a></li>
