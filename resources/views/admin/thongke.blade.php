	...
	<div class="content">
		...
		<div class="row">
			...
			<div class="col-lg-3">
				...
				<div class="panel bg-pink-400">
					<div class="panel-body">
						<h3 class="no-margin">{{$total_owner_deactive - $total_owner_active }}</h3>
						Người cho thuê đã duyệt
						<div class="text-muted text-size-small">trên tổng số {{  $total_owner_deactive}}  Đã đăng ký</div>
					</div>
